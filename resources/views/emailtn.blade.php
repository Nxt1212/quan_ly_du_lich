<div>
  ...
  border-width: 5px;">
   ...
   Tên tour: <b> {{$tour->t_title}} </b><br>
    ...
    @php
         $totalPrice = $book->b_number_adults * ($tour->t_price_adults-($tour->t_price_adults* $tour->t_sale/100) ) + $book->b_number_children * ($tour->t_price_adults-($tour->t_price_adults* $tour->t_sale/100));
     @endphp
